...
urlpatterns = [
      ...
      path('adminhome/produtos/<int:pk>/editar/', ProdutoUpdateView.as_view(), name='produtos_editar'),  # editar produto
       ...
       path('editar-perfil/', ClientePerfilEditarView.as_view(), name='editarperfil'),  # editar perfil
       path('perfil/pedido-<int:pk>/cancelar/', CancelarPedidoView.as_view(), name='cancelar_pedido'), #cancela pedido
      path('adminhome/clientes/', ListaClientesView.as_view(), name='lista_clientes'),
